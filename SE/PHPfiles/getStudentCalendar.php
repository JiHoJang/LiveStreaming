...
while($row = mysqli_fetch_array($result)) {
        array_push($response, array("SEND_DATE"=>$row['date'],"SEND_SN"=>$row['SN'],"SEND_TITLE"=>$row['title'], "SEND_INSTRUCTOR"=>$row['instructor'],"SEND_PRICE"=>$row['price'],"SEND_MAX_STUDENT"=>$row['max_student'],"SEND_NUM_STUDENT"=>$row['num_student'],"SEND_LECTURE_FEATURE"=>$row['lecture_feature']));
}
